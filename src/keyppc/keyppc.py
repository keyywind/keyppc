...
class PFPC:
    ...
    __WAIT_QUANTUM = 0.01
    def __init__(self, password, savepath = "./", exceptions = [], penalty = "start chrome.exe"):
        ...
        self.penalty = BasicUtils.verify_type(penalty, [str])
...
if (__name__ == "__main__"):
    listener = PFPC("abcd", "./", [Key.ctrl, KeyCode(char = 'o'), Key.end], "start firefox.exe")
    listener.run(10)